...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <br>
                <form class="user" action="../routers/r_kopi.php?aksi=tambah_kopi" method="post" enctype="multipart/form-data">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="text" name="id" id="id" hidden>
                        <div class="form-group ">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nama Kopi" name="kopi">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group ml-2">
                            <input type="file" class="file-control file-control-user" id="exampleInputPassword" name="p_kopi">
                        </div>
