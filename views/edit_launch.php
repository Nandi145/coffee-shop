...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <br>
            <form class="user" action="../routers/r_launch.php?aksi=update_launch" method="post" enctype="multipart/form-data">
                <div class="col-sm-12 mb-3 mb-sm-0">
                    <?php foreach ($cup->edit($_GET['id']) as $edit) : ?>
                        <input type="text" name="id" id="id" hidden value="<?= $edit->id ?>">
                        <div class="form-group ">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Nama launch" name="launch" value="<?= $edit->launch?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group ml-2">
                            <input type="file" class="file-control file-control-user" id="exampleInputPassword" name="p_launch" value="<?= $edit->img ?>">
                        </div>
