...
<div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <br>
            <?php foreach ($menu->minum($_GET["id"]) as $minu) : ?>
                <form class="user" action="../routers/r_cair.php?aksi=tambah" method="post" enctype="multipart/form-data">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                        <input type="text" name="id" id="id" hidden>
                        <div class="form-group ">
                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" aria-describedby="emailHelp" value="<?= $minu->minum ?>" placeholder="Coffee" name="cair" readonly>
                        </div>
                        <div class="form-group">
                        ...
                        <input type="text" name="jenis" id="jenis" value="MINUMAN" hidden>
